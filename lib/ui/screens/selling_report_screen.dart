...
import 'package:dp_perfum/ui/widgets/selling_report_list.dart';
import 'package:flutter/material.dart';

import '../widgets/app_scaffold.dart';
import '../widgets/date_range.dart';

class SellingReportScreen extends StatelessWidget {

  final _controller = ReportUiController();
  SellingReportScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AppScaffold(title: 'Satış hesabatı', body: Column(
      ...
      children: [
        ...
        Expanded(child: SellingReportList(controller: _controller))
      ],
    ));
  }
}
